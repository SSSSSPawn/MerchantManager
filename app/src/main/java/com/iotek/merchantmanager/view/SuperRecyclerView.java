...
public class SuperRecyclerView extends FrameLayout {
    ...
    protected OnLoadMoreListener mOnMoreListener;
    ...
    private boolean isPullToRefresh = true;//是否下拉刷新
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mPadding = (int) a.getDimension(R.styleable.superrecyclerview_recyclerPadding, -1);
            mPaddingTop = (int) a.getDimension(R.styleable.superrecyclerview_recyclerPaddingTop, 0);
            ...
            mMoreProgressId = a.getResourceId(R.styleable.superrecyclerview_layout_moreProgress, R.layout.listview_footer);
    ...
    private void initView() {
        ...
        mPtrLayout.setColorSchemeColors(Color.RED);
    ...
    private void processOnMore() {
        ...
        if (((totalItemCount - lastVisibleItemPosition) <= ITEM_LEFT_TO_LOAD_MORE ||
            ...
            if (mOnMoreListener != null) {
                ...
                mOnMoreListener.onLoadMore(mRecycler.getAdapter().getItemCount(), ITEM_LEFT_TO_LOAD_MORE, lastVisibleItemPosition);
            }
        }
    }
...
//    }
    ...
    public void setPullToRefreshEnable(boolean enable) {
        isPullToRefresh = enable;
        mPtrLayout.setEnabled(isPullToRefresh);
    }
    ...
    public void setOnRefreshListener(SwipeRefreshLayout.OnRefreshListener listener) {
        ...
        mPtrLayout.setEnabled(isPullToRefresh && true);
