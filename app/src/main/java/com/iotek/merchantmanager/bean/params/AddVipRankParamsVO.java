...
public class AddVipRankParamsVO extends BaseBean {
    ...
    public AddVipRankParamsVO(long custId, long rootId, String uuid, String mac, int membLevel, String levelName, String discount) {
        this.custId = custId;
        this.rootId = rootId;
        this.uuid = uuid;
        this.mac = mac;
