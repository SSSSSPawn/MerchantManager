...
public class CustomDatePicker {
    ...
    public CustomDatePicker(Context context, ResultHandler resultHandler/*, String startDate, String endDate*/) {
        if (isValidDate("yyyy-MM-dd HH:mm") && isValidDate( "yyyy-MM-dd HH:mm")) {
            ...
            try {
                ...
                endCalendar.setTime(sdf.parse("2177-01-01 00:00"));
    ...
    private void initView() {
        ...
        btn_cancle = (Button) datePickerDialog.findViewById(R.id.btn_cancle);
        btn_select = (Button) datePickerDialog.findViewById(R.id.btn_select);
     ...
     * 验证字符串是否是一个合法的日期格式
     */
    private boolean isValidDate(String template) {
