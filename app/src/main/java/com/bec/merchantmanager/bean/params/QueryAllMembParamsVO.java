...
public class QueryAllMembParamsVO extends BaseBean {
    ...
    public QueryAllMembParamsVO(long custId, long rootId, String uuid, String mac, int limit, int page) {
        this.custId = custId;
        this.rootId = rootId;
        this.uuid = uuid;
        this.mac = mac;
    ...
    public QueryAllMembParamsVO(long custId, long rootId, String uuid, String mac, int limit, int page, String membTel, String membName, int membLevel) {
        this.custId = custId;
        this.rootId = rootId;
        this.uuid = uuid;
        this.mac = mac;
